                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <input type="hidden" id="id" name="id">
                            <input id="codigo" class="form-control" type="text" name="codigo" placeholder="Codigo de producto" onkeyup="buscarCodigo(event)">
...
<div class="row">
        <div class="col-md-4 ml-auto">
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-compra mt-2 btn-block" onclick="procesar(1)">Generar Compra</button>
                </div>
